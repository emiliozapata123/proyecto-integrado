...
const InicioDocente = () => {
    const {data:cursos} = useFetch("/curso/docente/list");
    let cantAlumnos = 0;

    cursos.forEach(c => cantAlumnos += c.alumnos.length);
        ...
        <div className="pb-4 bg-light">
            ...
            <div className="row g-3 mb-4">
                ...
                <div className="p-3 bg-white rounded-4 shadow-sm border">
                    ...
                    <h3 className="fw-bold mt-2">{cantAlumnos}</h3>
                ...
                <div className="p-3 bg-white rounded-4 shadow-sm border">
                    ...
                    <h3 className="fw-bold mt-2">{cursos.length}</h3>
